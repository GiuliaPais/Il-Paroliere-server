...
public enum wordsOfGrid {
    ...
    GRID0("I T E U I N P H F T M I A I S L", "STIA","FINE","FINTA","LISTA","SLIP","TISI","PISTA","TINTA",
            "PENTITI","ISTINTI","INTIMI","LIMITI","PETI"),
    //+DELEGA DAGA MAGO MAGA LEGA GEL AGO DAMA MODA AEDO ODE
    // -OMEGA LEGO EGO AMI AMAI DEA LEGAMI
    GRID1("M O E L E G D E H A A A U U I M", "DELEGA","DAGA","MAGO","MAGA","LEGA","GEL","AGO","DAMA","MODA","AEDO","ODE",
            "OMEGA","LEGO","EGO","AMI","AMAI","DEA","LEGAMI"),
    ...
    GRID2("M A U E A A D R U N T A H E S A", "MANSARDA","MANDARE","MANDATA","DURATA","STRADA","ANDARE","ANDATA","DATARE","MANATA","AMANTE","SATANA","ANSARE","RASATA","MADRE","TENDA","STARE","RUDE","DAMA","DARE","DUE","RADA",
    ...
    GRID3("U I A I O P A A B L N O G H C O", "AIUOLA","PALCO","PIANA","PIANO","ALBO","PALO","CLAN","BOIA","LANA","PAIO","CONO","PIO","NAIA","ANO",
            "ALPI","PUOI","PAIA","POI","CON","ANA","NOA"),
    ...
    GRID4("T A R A I S L D C A F A N B U M", "SCIARADA","NASCITA","CALARSI","CIALDA","FASCIA","BASTIA","LANCIA","CIARLA","FALDA","TARSIA","DARSI",
    ...
    GRID5("I L B R N T M D A S O C E R H I", "CHIOSARE","COSTARE","CHIOSA","DOSARE","DOTARE","NITORE","OSTARE","TOSARE","SANTO","MORSA","CORSA","STARE","ROSTA",
    ...
    GRID6("F T M E R T B I U F I G U R E N", "REGIME","FINE","RENI","TIR","NERI","NEI","FINGE","FINGI","REGNI","TINGE","GENI","MIE"),
    //+METTERE TEMERE ACUME TETTA ETERE TBC RETE TECA
    // -NUTRE TUTTA RUTTA METTE CATTURE TEMETE
    GRID7("Z U A U M E C T E T T B E R U N", "METTERE","TEMERE","ACUME","TETTA","ETERE","TBC","RETE","TECA",
            "NUTRE","TUTTA","RUTTA","METTE","CATTURE","TEMETE"),
    ...
    GRID8("E S L O S O O E S D A N A F U E", "OLEOSO","FAUNO","DOSSO","ESODO","LEONE","SESSO","ESOSO","OSSEO","NUDO","FUNE","LODO","NODO","DOLO","DOSE",
    ...
    GRID9("O B H C V S A T P S A N O P N R", "SPANNA","CANAPO","POSATA","PANNA","NASPO","SPOSA","PASSO","BASSO","CANNA","NASSA","TASSO","TASSA","CASSA","POSA","ASPO","TANA",
    ...
    GRID10("N O E I V A T I E O P R A T H R", "POETA","NOVA","VANO","VETO","VOTO","VATE","RIPA","TIPO","TOP","NOTO","NOTA","EVO","AVO","NATO","RITO","IRTO","TOT","ATEO","TIR",
    ...
    GRID11("N R E D U T E U A V R A E B B E", "BEVUTA","RUDERE","BREVE","BARBA","AVERE","EREDE","BEARE","ETERE","ETERA","RUDE","BERE","VATE","ERBA","DUE","TABE",
    ...
    GRID12("A I S O N P E R B C F N I M I M", "SPANCERO","SPANIERO","CINESINA","INCINERO","PANCINE","FRENICI","ROSPINA","PERNICI","NEFROSI","INFERSI","OREFICI","SPAIERO","SINCERO",
